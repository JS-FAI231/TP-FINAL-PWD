    ...
    <div id="tienda_bg" class="container-fluid p-5 my-1">
        <div class="row">
            <div class="col-sm-12">
                ...
                <h2><img src=".\..\img\vinyl_transp.png" style="width:auto;height:80px"> Asignacion de Estados a Compras</h2>


                <table id="dg" style="width:100%;height:640px" url="listar.php" title="Compras-Estados" singleselect="true" fitcolumns="true" toolbar="#toolbar" pagination="true" rownumbers="true">
                    <thead>
                        <tr>
                ...
                <div id="toolbar" style="padding:3px">
                    <div class="row">
                        <div class="col-sm-8">
                            ...
                            <?php
                            $objABM = new ABMCompraestadotipo();
                            $lista = $objABM->buscar(null);
                            //Defino los botones para cada Rol
                            if (count($lista) > 0) {
                                foreach ($lista as $objCompraestadotipo) { ?>
                                    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="addestado(<?php echo $objCompraestadotipo->getIdcompraestadotipo(); ?>)"><?php echo $objCompraestadotipo->getDescripcion(); ?> </a>
                            <?php
                                }
                            }
                            ?>
                ...
                ddv.datagrid({
                    ...
                    columns: [
                        [{
                            ...
                            {
                                field: 'idcompraestadotipo',
                                title: 'ID Tipo Estado',
                                width: 25
                            },
                            {
                                field: 'descripcion',
