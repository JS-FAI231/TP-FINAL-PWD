...
<body>
    <div id="tienda_bg" class="container-fluid p-5 my-1">
        <div class="row">
            <div class="col-sm-12">
                <h2><img src=".\..\img\vinyl_transp.png" style="width:auto;height:80px"> ABM Roles</h2>
                <p>Podra realizar las siguientes acciones.</p>
                <br>
                <table id="dg" title="Administrador de items Rol" class="easyui-datagrid" style="width:100%;height:300px" toolbar="#toolbar" pagination="true" rownumbers="true" fitColumns="true" singleSelect="true" sortName="descripcion" sortOrder="asc" url="listar.php">
                    <thead>
                        <tr>
                            <th field="idrol" width="5%" sortable="true">ID</th>
                            <th field="descripcion" width="50%" sortable="true">Nombre</th>
                        </tr>
                    </thead>
                </table>
                <div id="toolbar" style="padding:3px">
                    <div class="row">
                        <div class="col-sm-8">
                            <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="nuevo()">Nuevo Rol</a>
                            <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="editar()">Editar Rol</a>
                            <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="eliminar()">Baja Rol</a>
                        </div>
                        <div class="col-sm-4">
                ...
                <div id="dlg" class="easyui-dialog" style="width:600px" data-options="closed:true,border:'thin',buttons:'#dlg-buttons'">
                    ...
                    <form id="fm" method="post" novalidate style="margin:0;padding:20px 50px">
                        ...
                        <div style="margin-bottom:10px">
                            <input name="descripcion" id="descripcion" class="easyui-textbox" required="true" label="Nombre:" style="width:100%">
                        </div>
                    </form>
...
<script type="text/javascript">
    ...
    function editar() {
        ...
        if (row) {
            ...
            $('#fm').form('load', row);
            url = 'accion.php?accion=editar&idrol=' + row.idrol;
        }
    }
    ...
    function eliminar() {
        ...
        if (row) {
            $.messager.confirm('Confirm', 'Seguro que desea eliminar el rol?', function(r) {
                if (r) {
                    $.post('./accion.php?accion=borrar&idrol=' + row.idrol, {
                            idrol: row.id
                        },
                        function(result) {
