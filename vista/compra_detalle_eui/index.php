    ...
    <div id="tienda_bg" class="container-fluid p-5 my-1">
        <div class="row">
            <div class="col-sm-12">
                ...
                <h2><img src=".\..\img\vinyl_transp.png" style="width:auto;height:80px"> Compras Realizadas</h2>


                <table id="dg" style="width:100%;height:640px" url="listar.php" title="Compras Realizadas con Detalle de Items" singleselect="true" fitcolumns="true" toolbar="#toolbar" pagination="true" rownumbers="true">
                    <thead>
                        <tr>
